...
This updates preview Markdown and block JSONL artifacts for new or changed
...
def main() -> None:
    ...
    # Incremental mode keeps previous previews when the raw file hash did not change.
